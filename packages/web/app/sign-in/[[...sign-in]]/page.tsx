        ...
        <div className="w-full max-w-[440px] mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-red-500/10 rounded-full border border-red-500/20 backdrop-blur-sm mb-4">
              ...
              <span className="text-red-400 text-xs sm:text-sm font-medium">WELCOME BACK</span>
            </div>
            
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">
              Sign In to <span className="text-red-500">Redline</span>
            </h1>
            <p className="text-white/60 text-sm sm:text-base">
              Access your exclusive automotive community
            </p>
          </div>

          {/* Clerk Sign In Component - Improved container */}
          ...
          {/* Optional: Compact feature showcase for larger screens */}
          <div className="hidden lg:flex items-center justify-center gap-6 mt-12">
            ...
            <div className="flex items-center gap-2 text-white/40 text-sm">
              <div className="w-4 h-4 bg-gradient-to-r from-red-500/60 to-red-600/60 rounded flex items-center justify-center">
